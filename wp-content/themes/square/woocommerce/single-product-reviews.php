...
<div id="reviews" class="woocommerce-Reviews">
	<div id="comments">
		...
		<?php else : ?>
			...
			<p class="woocommerce-noreviews"><?php esc_html_e( 'There are no reviews yet.', 'square' ); ?></p>
		...
		<div id="review_form_wrapper">
			<div id="review_form">
				<?php
					...
					$comment_form = array(
						'title_reply'          => have_comments() ? esc_html__( 'Add a review', 'square' ) : sprintf( 
							/* translators: Title */
							esc_html__( 'Be the first to review &ldquo;%s&rdquo;', 'square' ), get_the_title() ),
						'title_reply_to'       => esc_html__( 'Leave a Reply', 'square' ),
					...
					if ( $account_page_url = wc_get_page_permalink( 'myaccount' ) ) {
						$comment_form['must_log_in'] = '<p class="must-log-in">' . sprintf( 
							/* translators: account page url */
							__( 'You must be <a href="%s">logged in</a> to post a review.', 'square' ), esc_url( $account_page_url ) 
						) . '</p>';
					}
	...
	<?php else : ?>
		...
		<p class="woocommerce-verification-required"><?php esc_html_e( 'Only logged in customers who have purchased this product may leave a review.', 'square' ); ?></p>
